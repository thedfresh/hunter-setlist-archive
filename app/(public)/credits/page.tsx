    ...
    return (
        <PageContainer variant="text">
            ...
            <section className="mb-8">
                ...
                <p className="mb-4"><ExternalLink href="https://musicimages.com/">Ed Perlstein</ExternalLink> has provided a wealth of Dinosaurs dates and info that will make its way here in the near future.  Check out his amazing photographs of Hunter (and other rock legends!).</p>
