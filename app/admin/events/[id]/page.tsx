...
export default function EventDetailPage() {
    ...
    async function loadEventData() {
        try {
            // Use numeric ID if available, otherwise use slug from URL params
    ...
    useEffect(() => {
        ...
        if (newSortDate) {
            // Format for datetime-local input (UTC)
    ...
    async function handleSave(e: React.FormEvent) {
        ...
        try {
            ...
            // Use numeric ID if available, otherwise use slug from URL params
            const eventIdToSave = eventIdNumeric || eventSlug;
            const res = await fetch(`/api/admin/events/${eventIdToSave}`, {
                method: "PUT",
            ...
            await loadEventData(); // Reload to get updated slug/sortDate
        } catch (err: any) {
    ...
    if (loading) {
        return (
            <div className="page-container">
                <div className="loading-state"><div className="spinner"></div>Loading event...</div>
            </div>
        );
    }
            ...
            <form onSubmit={handleSave} className="space-y-6">
                ...
                <div>
                    ...
                    <details className="mb-4">
                        <summary className="cursor-pointer user-select-none font-medium mb-4">Raw Data</summary>
